...
class NetMicBase:
    def __init__(self, host: str, port: int, remote_port: int, is_server: bool):
        ...
        self.channel_as_server = CommunicationServer(host, port, message_size=CONTROL_MESSAGE_SIZE if is_server else DATA_MESSAGE_SIZE)
