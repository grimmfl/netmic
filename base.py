...
class NetMicBase:
    def __init__(self, port: int, remote_host: str, remote_port: int, is_server: bool):
        self.channel_as_client = CommunicationClient(remote_host, remote_port, message_size=DATA_MESSAGE_SIZE if is_server else CONTROL_MESSAGE_SIZE)
